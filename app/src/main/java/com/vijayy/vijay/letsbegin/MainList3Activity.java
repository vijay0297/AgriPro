...
public class MainList3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_list3);
        mdatabase= FirebaseDatabase.getInstance().getReference().child("plant3");
        mbloglist=(RecyclerView)findViewById(R.id.blogview3);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId()==R.id.action_add){
            startActivity(new Intent(MainList3Activity.this,PostActivity.class));
        }
