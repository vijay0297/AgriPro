...
public class     MainList4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_list4);
        mdatabase= FirebaseDatabase.getInstance().getReference().child("plant4");
        mbloglist=(RecyclerView)findViewById(R.id.blogview4);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId()==R.id.action_add){
            startActivity(new Intent(MainList4Activity.this,PostActivity.class));
        }
