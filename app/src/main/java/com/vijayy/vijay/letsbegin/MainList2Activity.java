...
public class MainList2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdatabase= FirebaseDatabase.getInstance().getReference().child("plant2");
        mbloglist=(RecyclerView)findViewById(R.id.blogview2);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId()==R.id.action_add){
            startActivity(new Intent(MainList2Activity.this,PostActivity.class));
        }
