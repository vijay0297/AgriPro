...
public class MainList5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_list5);
        mdatabase= FirebaseDatabase.getInstance().getReference().child("plant5");
        mbloglist=(RecyclerView)findViewById(R.id.blogview5);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId()==R.id.action_add){
            startActivity(new Intent(MainList5Activity.this,PostActivity.class));
        }
